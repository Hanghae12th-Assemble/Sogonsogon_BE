...
public class AudioClipCommentController {
    ...
    public StatusResponseDto<AudioClipCommentResponseDto> createdComment(@PathVariable Long audioclipId, @RequestBody String content, @Parameter(hidden = true)@AuthenticationPrincipal UserDetailsImpl userDetails){
    ...
    public StatusResponseDto<AudioClipCommentResponseDto> updatedComment(@PathVariable Long commentId, @RequestBody AudioClipCommentRequestDto requestDto, @Parameter(hidden = true)@AuthenticationPrincipal UserDetailsImpl userDetails){
    ...
    public StatusResponseDto<List<AudioClipCommentResponseDto>> getComments(@PathVariable Long audioclipId){
