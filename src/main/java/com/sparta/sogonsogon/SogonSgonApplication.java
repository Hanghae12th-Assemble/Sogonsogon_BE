...
@SpringBootApplication
@EnableJpaAuditing
@OpenAPIDefinition(servers = {@Server(url = "https://nocheeze.shop", description = "https Server"), @Server(url = "http://localhost:8080", description = "Local Server URL"),@Server(url= "http://3.34.23.248:8080", description = "http서버 입니다. ")})
public class SogonSgonApplication {
